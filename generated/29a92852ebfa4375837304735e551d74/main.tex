...
\textsckqfdbkxv at \textit{qsksbkcbkSB} (KKSKBFBBQS)  \dates{2024-12--2025-04} \\

% ------------------------ ÉDUCATION ----------------------------------------
\headright{Education}
\textsckddbfb qfklbq flksqfqs klqed. \textit{k dqvkbbqsv vqdvklbq.} \dates{2012-2015} \\

% ------------------------ CERTIFICATIONS ------------------------------------
\headright{Certifications}
\smaller{\textscks{LD}}, \textit{KSLQKBC.} \dates{Jul-2024} \\
