...
\makeatletter
\@ifundefined{faBrain}{\newcommand{\faBrain}{\textbullet}}{}
\@ifundefined{faMicrochip}{\newcommand{\faMicrochip}{\textbullet}}{}
\@ifundefined{faHandshakeO}{\newcommand{\faHandshakeO}{\textbullet}}{}
\makeatother
...
\color{sidetext}
% Décalage vertical de 10cm vers le haut
\vspace*{-10cm}
...
\begin{tabular}{@{}c l}
    ...
    \begin{tabular}[t]{@{}l@{}}
        {\color{gray}LinkedIn} \\
        \href{https://linkedin.com/in/jeandupont}{in/jeandupont}
    \end{tabular} \\
    \\
    \faMapMarker & 
    \begin{tabular}[t]{@{}l@{}}
