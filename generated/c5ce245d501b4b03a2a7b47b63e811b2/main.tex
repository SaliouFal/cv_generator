...
\usepackage{fontawesome}  % Package fontawesome standard
...
% Coordonnées - MODIFICATION ICI : Site Web remplacé par Email
\begin{tabular}{@{}c l}
    \faPhone & 
    \begin{tabular}[t]{@{}l@{}}
    ...
    \end{tabular} \\
    \\
    % ICI : Site Web remplacé par Email avec icône d'enveloppe
    \faEnvelope & 
    \begin{tabular}[t]{@{}l@{}}
        {\color{gray}Email} \\
