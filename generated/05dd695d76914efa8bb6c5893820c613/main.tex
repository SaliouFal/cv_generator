Voici le document mis à jour avec l’ajout d’une session « Hobbies » dans la colonne latérale :
...
\begin{center}
            \begin{tikzpicture}
            \clip (0,0) circle (1.5cm) node[anchor=center] {\includegraphics[width=3cm]{595f22f0dd2448f2b625fe1422f808a1.png}}; 
            \end{tikzpicture}
...
{\color{gray}\rule{\linewidth}{0.4pt}} \\
 ...
 \begin{tabular}{cl}
        ...
        \begin{tabular}{ll}
            \faFutbolO{} & Football \\[6pt]
            \faCamera{}  & Photographie \\[6pt]
            \faMusic{}   & Guitare \\
        \end{tabular}
%------------------------------------------------------------------
