Voici le document mis à jour avec l’ajout du « Master 1 Data Science – Université Paris-Saclay (2017) » dans la section Formation :
...
\begin{center}
            \begin{tikzpicture}
            \clip (0,0) circle (1.5cm) node[anchor=center] {\includegraphics[width=3cm]{a87c3f3e57e74793b2fe3a77a91ccd31.png}}; 
            \end{tikzpicture}
...
% ---------- Déjà présent : Master 2 Data Science ----------
\begin{tabular}{@{}cp{0.7\linewidth}}
      \begin{minipage}{0.05\linewidth}
        \includegraphics[width=\linewidth]{picon.png}
      \end{minipage} & \vspace{-12pt}
