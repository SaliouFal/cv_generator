Voici la version corrigée : les points (bullet points) vides ont été retirés dans les rubriques « Expérience » et « Certifications ».
...
1. Suppression du second bloc `\colorbox{maincolor}{...}` vide de la section « Expérience Professionnelle ».
2. Suppression de la ligne `\item` vide dans la section « Certifications ».