...
\begin{minipage}[t]{0.33\textwidth}
  ...
  \colorbox{cvblue!90}{%
    ...
    \begin{minipage}[t][293mm][t]{0.82\textwidth}\raggedright
      ...
      % -------- Profil -------------------------------------------
      \headleft{Profil}
      Technicien support informatique orienté marketing digital : configuration, maintenance et assistance utilisateurs. Après une alternance en gestion de projets numériques à la mairie du Gosier, je cherche à relever de nouveaux défis et optimiser vos solutions IT.
